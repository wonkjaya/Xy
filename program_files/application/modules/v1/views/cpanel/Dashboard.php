		  ...
		  <div class="panel-body">
		    <?php
		  	if(count($akun_data) > 0){
		  		...
		  		$address=$akun_data->address;
		  		$phonenumber=$akun_data->phonenumber;
		  	}
		  ?>
	...
	<div class="col-md-6">
		<!--panel produk-->
		  ...
		  <div class="panel-heading">
			<span class="text-left">Log Terakhir</span>
			<?=anchor('','More','class="right"')?>
		</div>
		  <div class="panel-body">
		    <table class="table table-bordered" style="max-width:100%">
		    	...
		    	<tr>
		    		...
		    		<td><?=($row->status==100)?'<i style="color:red">'.$row->keterangan.'</i>':$row->keterangan?></td>
		    	</tr>
		    	<?php
		    		$no++;
		    	 endforeach;
